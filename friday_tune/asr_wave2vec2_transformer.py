...
from friday.asr.models.ctc_wave2vec_model import EncDecCTCModelWave2Vec2


@hydra_runner(config_path="base_config", config_name="wave2vec2_transformer_nemo.yaml")
def main(cfg):
    ...
    asr_model = EncDecCTCModelWave2Vec2(cfg=cfg.model, trainer=trainer)

    asr_model.encoder.freeze()  # freeze encoder, no grad cache
